...
const Index = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Track your application progress with interactive calendar and roadmap views.",
      path: "/journey"
    },
    {
      icon: <Briefcase className="h-8 w-8 text-magic-pink" />,
      title: "University Bucket",
      description: "Save and organize your target schools with automatic deadline tracking.",
      path: "/uni-bucket"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-magic-light to-white overflow-hidden">
      ...
      <section className="pt-32 md:pt-40 pb-16 md:pb-24 px-4">
        ...
        <div className="absolute top-60 right-10 w-32 h-32 rounded-full bg-magic-purple/10 animate-float" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-20 left-1/4 w-16 h-16 rounded-full bg-magic-pink/10 animate-float" style={{ animationDelay: '2s' }}></div>
      </section>
      
      {/* Features Section */}
      <section className="py-16 px-4 bg-white/50">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Magical Features</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-2 text-center group-hover:text-magic-purple transition-all-200">{feature.title}</h3>
