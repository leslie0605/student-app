...
const SoPDashboard: React.FC<SoPDashboardProps> = ({ sopVersions }) => {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      // Upload to server
      const response = await fetch("http://localhost:3000/api/documents/sop", {
        method: "POST",
        body: formData,
      });
      ...
      const feedback = result.data?.analysis?.feedback || [
        "Your Statement of Purpose has been uploaded successfully.",
        "We are analyzing your statement for improvement opportunities.",
        "Consider adding more specific research interests and potential faculty collaborators.",
      ];
      ...
      toast({
        ...
        description: `Your Statement of Purpose has been uploaded and scored ${score}/100.`,
      });
    } catch (error) {
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-2xl font-bold">Statement of Purpose</h2>
          <p className="text-sm text-muted-foreground mt-1">
            Upload and manage your Statement of Purpose documents
          </p>
        </div>
        <Dialog open={isUploadDialogOpen} onOpenChange={setIsUploadDialogOpen}>
          ...
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Upload your SOP as a PDF or DOCX file to get AI-powered feedback
              </DialogDescription>
            </DialogHeader>
        ...
        <Card className="border-dashed border-2 p-8">
          <CardContent className="flex flex-col items-center justify-center p-6">
            ...
            <p className="text-center text-muted-foreground mb-4">
              Upload your Statement of Purpose to get feedback and improve your
              chances
            </p>
