...
const PHSDashboard: React.FC<PHSDashboardProps> = ({ phsVersions }) => {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      // Upload to server
      const response = await fetch("http://localhost:3000/api/phs/upload", {
        method: "POST",
        body: formData,
      });
      ...
      const fileUrl =
        result.data?.fileUrl ||
        `http://localhost:3000/api/phs/files/${selectedFile.name.replace(
          /\s+/g,
          "_"
        )}`;
      const score = result.data?.analysis?.score || 0;
      const feedback = result.data?.analysis?.feedback || [
        "Your PHS has been uploaded successfully.",
        "We are analyzing your PHS for improvement opportunities.",
        "Consider adding more details to your background experiences.",
      ];
      ...
      toast({
        ...
        description: `Your PHS has been uploaded and scored ${score}/100.`,
      });
    } catch (error) {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Your PHS has been sent to your mentor for review.",
        });
      } else {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h3 className="text-xl font-semibold">Personal History Statement Dashboard</h3>
        <div className="flex space-x-2">
          ...
          >
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Upload your current PHS. Supported formats: PDF, DOCX.
                </DialogDescription>
              </DialogHeader>
              <div className="py-6">
                <div
                  ...
                  {selectedFile ? (
                    ...
                    <>
                      ...
                      <p className="mb-2 text-sm text-center">
                        Drag and drop your PHS here, or click to browse
                      </p>
                      <p className="text-xs text-muted-foreground mb-4">
          ...
          >
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Create New PHS Version</DialogTitle>
                <DialogDescription>
              ...
              <div className="py-4">
                ...
                <p className="text-center text-muted-foreground">
                  PHS creation form would go here
                </p>
              </div>
            </DialogContent>
          </Dialog>
      ...
      {versions.length === 0 ? (
        <Card className="border-dashed border-2">
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <h3 className="text-lg font-medium mb-2">No PHS versions yet</h3>
            <p className="text-muted-foreground text-sm max-w-md text-center mb-6">
              Upload your first Personal History Statement to get started with
                ...
                {version.feedback && version.feedback.length > 0 && (
                  <div className="mb-4">
                    ...
                    <div className="text-xs text-muted-foreground mt-1 flex justify-between">
                      <span>AI-generated feedback based on PHS analysis</span>
                      {version.score !== undefined && (
                        <span
                          className={`font-medium ${scoreColor(version.score)}`}
                        >
