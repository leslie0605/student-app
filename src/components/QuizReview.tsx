  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      <div className="mb-6 p-4 bg-magic-purple/10 rounded-lg">
        <h2 className="text-xl font-bold text-magic-purple mb-2">
          Quiz Review
        </h2>
        <p className="text-muted-foreground">
          You've already completed this quiz. Here are your answers and the
          correct solutions.
        </p>
      </div>
      ...
      <div className="space-y-6 mb-8">
        {userAnswers.map((answer) => {
          ...
          const correctOption = options.find(
            (r: any) => r.id === question.correctConcept
          );
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-3 p-3 bg-magic-blue/5 rounded-lg">
                    <h4 className="text-sm font-medium mb-1 text-magic-blue">
                      Explanation:
                    </h4>
