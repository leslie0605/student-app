...
const mockApplicationTasks: ApplicationTask[] = [
  {
    ...
    description: 'Look up faculty members and research interests at target universities.',
  ...
  },
  {
    ...
    description: 'Contact undergraduate institution to request official transcripts.',
  ...
  },
  {
    ...
    description: 'Reach out to potential recommenders and provide necessary information.',
    dueDate: new Date(new Date().getFullYear(), new Date().getMonth(), new Date().getDate() + 15).toISOString(),
    completed: false,
  ...
  },
  {
    ...
    dueDate: new Date(new Date().getFullYear(), new Date().getMonth() + 2, 1).toISOString(),
    completed: false,
    category: 'Submissions',
    university: 'MIT',
    priority: 'high'
